                ...
                @else
                    ...
                    <div class="alert alert-info">
                        ...
                        <ol class="mb-0">
                            ...
                            <li>
                                Format video berupa link youtube.
                            </li>
                        </ol>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="test_date" name="test_date" class="form-control
                                                                            @error('test_date') is-invalid @enderror" value="{{ old(
                'test_date',
                date('Y-m-d')
            ) }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <select id="juz" name="juz" class="form-control
                                                                            @error('juz') is-invalid @enderror" required>
                                    <option value="">
                                        -- Pilih Juz --
                                    </option>

                                    @for($i = 1; $i <= 30; $i++)
                                                        <option value="{{ $i }}" {{ old('juz') == $i
                                        ? 'selected'
                                        : ''
                                                                                                                                                                                    }}>
                                                            Juz {{ $i }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="surat" name="surat" class="form-control
                                    ...
                                    placeholder="Contoh: Al-Baqarah, Yasin, Al-Mulk" value="{{ old('surat') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="ayat" name="ayat" class="form-control
                                    ...
                                    placeholder="Contoh: 1-10" value="{{ old('ayat') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="keterangan_bacaan" name="keterangan_bacaan" class="form-control
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" name="video_url" id="video_url"
                                    ...
                                    value="{{ old('video_url', $test->video_url ?? '') }}"
                                    placeholder="https://www.youtube.com/watch?v=xxxxxxxxxxx" required>

                                <small class="text-muted">
                                    Note: <br>
                                    Upload video terlebih dahulu ke YouTube, kemudian masukkan link video di sini.<br>
                                    Posisi wajib duduk dan mata harus sejajar dengan camera.<br>
                                </small>
