<form action="{{ route('siswa.dokumen.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col">
            @if (isset($dokumen->file_ktp))
                <div class="row">
                    <div class="col">
                        <img src="{{ url($dokumen->file_ktp) }}" width="100" class="img-fluid">
                    </div>
                </div>
            @endif
            <!-- Elemen untuk Preview Gambar Baru -->
            ...
            <input type="file" class="form-control @error('file_ktp') is-invalid @enderror" name="file_ktp"
                id="file_ktp" accept=".jpeg, .jpg, .png" onchange="previewImage()">
    ...
    <div class="row mt-4">
        ...
        <div class="col">
            @if (isset($dokumen->file_ijazah))
                <div class="row">
                    <div class="col">
                        <img src="{{ url($dokumen->file_ijazah) }}" width="100" class="img-fluid">
                    </div>
                </div>
            @endif
            <!-- Elemen untuk Preview Gambar Baru -->
        ...
        <div class="col">
            @if (isset($dokumen->file_kip))
                <div class="row">
                    <div class="col">
                        <img src="{{ url($dokumen->file_kip) }}" width="100" class="img-fluid">
                    </div>
                </div>
            @endif
            <!-- Elemen untuk Preview Gambar Baru -->
