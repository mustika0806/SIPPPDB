        ...
        <div class="container">
            ...
            <div class="card card-form">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <label>Tinggi Badan <span class="required-star">*</span></label>
                        <input type="number" id="tinggi_badan" class="form-control" min="1" placeholder="Contoh: 165">
                    </div>

                    <div class="col-md-4 mt-2">
                        <label>Berat Badan <span class="required-star">*</span></label>
                        <input type="number" id="berat_badan" class="form-control" min="1" placeholder="Contoh: 55">
                    </div>

                    <div class="col-md-4 mt-2">
                        <label>NIK <span class="required-star">*</span></label>
                        <input type="text" id="nik" class="form-control" maxlength="16" inputmode="numeric">
                    </div>

                    <div class="col-md-4 mt-2">
                        <label>Tanggal Pendaftaran <span class="required-star">*</span></label>
                    ...
                    <div class="col-md-4 mt-2">
                        <label>Jumlah Saudara <span class="required-star">*</span></label>
                        <input type="number" id="jumlah_saudara" class="form-control" min="0">
                    </div>

                    <div class="col-md-4 mt-2">
                        <label>No Akta Lahir <span class="required-star">*</span></label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <label>Kewarganegaraan <span class="required-star">*</span></label>
                    ...
                    <div class="col-md-4">
                        <label>Kebutuhan Khusus <span class="required-star">*</span></label>
                    ...
                    <div class="col-md-4">
                        <label>Anak Ke- <span class="required-star">*</span></label>
                        <input type="number" id="anak_ke" class="form-control" min="1">
                    </div>

                    <div class="col-md-4 mt-2">
                        <label>Apakah Siswa Pindahan? <span class="required-star">*</span></label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea id="alamat_asal" class="form-control" rows="3"></textarea>
                    </div>

                    <div class="col-md-3 mt-2">
                        <label>RT <span class="required-star">*</span></label>
                        <input type="text" id="rt" class="form-control" inputmode="numeric">
                    </div>

                    <div class="col-md-3 mt-2">
                        <label>RW <span class="required-star">*</span></label>
                        <input type="text" id="rw" class="form-control" inputmode="numeric">
                    </div>

                    <div class="col-md-3 mt-2">
                        <label>Dusun <span class="required-star">*</span></label>
                        <input type="text" id="dusun" class="form-control">
                    </div>

                    <div class="col-md-3 mt-2">
                        <label>Kode Pos <span class="required-star">*</span></label>
                        <input type="text" id="kode_pos" class="form-control" maxlength="5" inputmode="numeric">
                    </div>
                    ...
                    <div class="col-md-4 mt-2">
                        <label>Kota <span class="required-star">*</span></label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mt-2">
                        ...
                        <input type="text" id="no_telp" class="form-control" inputmode="tel">
                    </div>

                    <div class="col-md-4 mt-2">
                        <label>No HP Siswa <span class="required-star">*</span></label>
                        <input type="text" id="no_hp" class="form-control" inputmode="tel">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mt-2">
                        ...
                        <input type="email" id="alamat_email" class="form-control">
                    </div>

                    <div class="col-md-4 mt-2">
                        <label>Kegiatan Olahraga <span class="required-star">*</span></label>
                    ...
                    <div class="col-md-4 mt-2">
                        <label>Kegiatan Kesenian <span class="required-star">*</span></label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <label>Tempat Tinggal <span class="required-star">*</span></label>
                    ...
                    <div class="col-md-4">
                        <label>Transportasi <span class="required-star">*</span></label>
                    ...
                    <div class="col-md-4">
                        <label>Penerima KPS/PKH <span class="required-star">*</span></label>
            ...
            <button type="button" class="btn btn-success w-100 mt-4" id="next">
