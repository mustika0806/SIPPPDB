            ...
            <div class="card-body">
                <form action="{{ route('admin.quran.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="surat" class="form-control @error('surat') is-invalid @enderror"
                            placeholder="Contoh: An-Nisa" value="{{ old('surat') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="ayat" class="form-control @error('ayat') is-invalid @enderror"
                            placeholder="Contoh: 1-10" value="{{ old('ayat') }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="keterangan_bacaan"
                            class="form-control @error('keterangan_bacaan') is-invalid @enderror" rows="3"
